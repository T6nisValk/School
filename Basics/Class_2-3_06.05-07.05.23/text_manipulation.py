...
print("\nLength of the string is", len(text_variable))  # Prints the length of the string.
...
print("\nLetters between 0 to 7 index stepped by 2 are", text_variable[0:7:2])  # :2 gives 2 steps
